  ...
  return (
    <main className=" border-b bg-lightGray">
        ...
        <section className="bg-white py-4">
            <div className="cont flex justify-center mb-4"><CustomHeader text={'In partnership with'}/></div>
